...
#define BVIEW_BST_UCAST_THRES_DEFAULT                 (0x3FFF * 8 * 208)
...
#define BVIEW_BST_E_P_SP_UC_THRES_DEFAULT             (0x3FFF * 8 * 208)
...
#define  BVIEW_BST_UCAST_QUEUE_GROUP_DEFAULT          (0x3FFF * 8 * 208)

/* default settings of the BST buffers for TD2 */
#define SB_BRCM_BST_STAT_ID_DEVICE_DEFAULT 0x1FFFF
#define SB_BRCM_BST_STAT_ID_PRI_GROUP_SHARED_DEFAULT 0x1FFFF
#define SB_BRCM_BST_STAT_ID_PRI_GROUP_HEADROOM_DEFAULT 0xFFF
#define SB_BRCM_BST_STAT_ID_PORT_POOL_DEFAULT 0xEA77
#define SB_BRCM_BST_STAT_ID_ING_POOL_DEFAULT 0xDC0B
#define SB_BRCM_BST_STAT_ID_EGR_UCAST_PORT_SHARED_DEFAULT  (0xd942 * 8)
...
#define SB_BRCM_BST_STAT_ID_UCAST_DEFAULT (0xea77 * 8)
#define SB_BRCM_BST_STAT_ID_UCAST_GROUP_DEFAULT (0x1ff * 8)
