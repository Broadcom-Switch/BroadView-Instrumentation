/*********************************************************************
  ...
  ***********************************************************************
  *
  * @filename get_black_hole_detection.c 
  *
...
BVIEW_STATUS bhdjson_get_black_hole_detection (void *cookie, char *jsonBuffer, int bufLength)
{
    ...
    BHDJSON_GET_BLACK_HOLE_DETECTION_t command;
    ...
    /* Ensure that 'method' in the JSON equals "get-black-hole-detection" */
    JSON_COMPARE_STRINGS_AND_CLEANUP ("method", &method[0], "get-black-hole-detection-enable");
    ...
    status = bhdjson_get_black_hole_detection_impl (cookie, asicId, id, &command);
