...
BVIEW_STATUS bhdjson_cancel_black_hole (void *cookie, char *jsonBuffer, int bufLength)
{
    ...
    BHDJSON_CANCEL_BLACK_HOLE_t command;
    ...
    /* Ensure that 'method' in the JSON equals "cancel-black-hole" */
    JSON_COMPARE_STRINGS_AND_CLEANUP ("method", &method[0], "cancel-black-hole");
    ...
    status = bhdjson_cancel_black_hole_impl (cookie, asicId, id, &command);
